...
// // ===============================
// export async function drawMultiPolygon(multiPolygonCoords, points) {
//   const { AdvancedMarkerElement } = await google.maps.importLibrary("marker");

//   const drawn = new Set(); // ✅ глобально для всіх полігонів
...
//     // const area = spherical.computeArea(polygon.getPath());
...
// export function assignNumbers(flattenArray, startNumber) {
//   const result = [];
//   let currentNumber = startNumber;

//   flattenArray.forEach((coord) => {
//     const key = getCoordKey(coord);

//     if (coordMap.has(key)) {
//       result.push({
//         coord,
//         number: coordMap.get(key),
//       });
//     } else {
//       coordMap.set(key, currentNumber);
